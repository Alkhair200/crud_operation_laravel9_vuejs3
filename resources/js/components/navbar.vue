        ...
        <div class="navbar-wrapper">
            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <router-link class="navbar-brand" to="/">
                    <img class="brand-logo" alt="modern admin logo" src="dashboard_file/app-assets/images/logo/logo.png">
            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Mega</a>
                    ...
                    <li class="col-md-2">
                        ...
                        <div>
                            <img class="rounded img-fluid mb-1" src="{{ asset('dashboard_file/app-assets/images/slider/slider-2.png') }}"
                ...
                <li class="dropdown dropdown-user nav-item">
                    ...
                    <span class="mr-1">Hello,
                        <span class="user-name text-bold-700">Name User</span>
                    </span>
                    <span class="avatar avatar-online">
                        <img src="dashboard_file/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#"><i class="ft-user"></i> Edit Profile</a>
                    <router-link class="dropdown-item" to="/register"><i class="ft-power"></i> Register</router-link>                    
                    <router-link class="dropdown-item" to="/login"><i class="ft-power"></i>Login</router-link>                    
                   
                    <router-link class="dropdown-item" to="/posts"><i class="ft-power"></i> Posts</router-link>
                    </div>
                </li>
                    ...
                    <li class="scrollable-container media-list w-100">
                        ...
                        <div class="media">
                            ...
                            <span class="avatar avatar-sm avatar-online rounded-circle">
                                <img src="{{ asset('dashboard_file/app-assets/images/portrait/small/avatar-s-19.png') }}" alt="avatar"><i></i></span>
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            ...
                            <span class="avatar avatar-sm avatar-busy rounded-circle">
                                <img src="{{ asset('dashboard_file/app-assets/images/portrait/small/avatar-s-2.png') }}" alt="avatar"><i></i></span>
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="media-left">
                            <span class="avatar avatar-sm avatar-online rounded-circle">
                                <img src="{{ asset('dashboard_file/app-assets/images/portrait/small/avatar-s-3.png') }}" alt="avatar"><i></i></span>
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            ...
                            <span class="avatar avatar-sm avatar-away rounded-circle">
                                <img src="{{ asset('dashboard_file/app-assets/images/portrait/small/avatar-s-6.png') }}" alt="avatar"><i></i></span>
                            </div>
                            <div class="media-body">
